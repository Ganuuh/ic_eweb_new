...
export const TimeLapseComponent = ({
  ...
  return achievement ? (
    <div className="w-[100vw] md:w-full flex flex-col gap-[12px] md:gap-[28px] items-center">
      ...
      <ResponsiveContainer>
        <div className="w-full h-fit relative flex items-center gap-[10px]">
          <ArrowLeftOutlined
            onClick={handlePrev}
            style={{
              fontSize: 20,
            ...
            className=" md:absolute md:right-[100%] md:pr-[20px]"
          />
          ...
          <ArrowRightOutlined
            ...
            className=" md:absolute md:left-[100%] md:pl-[20px]"
          />
        </div>
      </ResponsiveContainer>
    </div>
